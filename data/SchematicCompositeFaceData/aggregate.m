% AGGREGATE DATA - based on SPSS aggregate function
function aggregatedata = aggregate(data, breakcolumns, dependentcolumn, varargin)
optargs = {@mean, 0, 0};
...
[aggfunction, suppressIdx, tol] = optargs{:};

%%
[x, y] = consolidator(data(:,breakcolumns), data(:,dependentcolumn), aggfunction, tol);
