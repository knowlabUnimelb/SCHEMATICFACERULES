...
if plotGRT
    set(plot1, 'XLim', [0 2], 'YLim', [0 2.5], 'XTick', 1, 'XTickLabel',...
        xlabels);
...
if plotLBA
    set(plot2, 'XLim', [0 2], 'YLim', [0 1], 'XTick', 1, 'XTickLabel',...
        xlabels);
...
if plotLBA2
    set(plot3, 'XLim', [0 2], 'YLim', [0 .5], 'XTick', 1, 'XTickLabel',...
        xlabels);
...
if plotLBA3
    set(plot4, 'XLim', [0 2], 'YLim', [0 1], 'XTick', 1:17, 'XTickLabel',...
        xlabels);
    legend([h.pX], 'pX')
    xlabel('Subject')
    ylabel('Density')
